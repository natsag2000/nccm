<template>
  <div class="container page">
    <div class="mx-4 pt-4 my-4">
      <span class="text-3xl uppercase">Эрсдлийг бууруулах</span>
    </div>
      ...
      <div class="flex flex-col mx-4 md:w-1/2">
       <div class="pt-4">
          <div class="bg-gray-100 border rounded-lg overflow-hidden">
            <img class="w-full object-cover" src="img/ersdelt_huchin_zuil2.jpg">
          </div>
        </div>
      </div>
    </div>
...
<script>
import mdContent from '~/static/content/ersdliig-buuruulah.md'
export default {
  computed: {
    pageContent () {
      return mdContent
